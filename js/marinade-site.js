(function () {
  ...
  function initComparisonSlider() {
    ...
    if (window.PointerEvent) {
      comparison.addEventListener("pointermove", function (e) {
        scheduleUpdate(e.clientX);
      });
      comparison.addEventListener("pointerdown", function (e) {
      ...
      comparison.addEventListener("pointerup", function (e) {
        try {
          if (comparison.hasPointerCapture && comparison.hasPointerCapture(e.pointerId)) {
            comparison.releasePointerCapture(e.pointerId);
          }
        } catch (err2) {}
      });
      comparison.addEventListener("pointercancel", function (e) {
        try {
          if (comparison.hasPointerCapture && comparison.hasPointerCapture(e.pointerId)) {
            comparison.releasePointerCapture(e.pointerId);
          }
